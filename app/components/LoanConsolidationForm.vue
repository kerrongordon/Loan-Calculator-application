      ...
      <div v-if="latestResult" class="space-y-6 rounded-3xl border border-primary/20 bg-primary/5 p-6 sm:p-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
        ...
        <div class="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
          <div class="bg-white/60 rounded-2xl p-4 border border-border/40 shadow-sm backdrop-blur-sm">
            ...
            <p class="text-xl font-extrabold text-foreground">{{ currency(latestResult.totalConsolidatedPrincipal) }}</p>
          </div>
          <div class="bg-white/60 rounded-2xl p-4 border border-border/40 shadow-sm backdrop-blur-sm">
          ...
          <div class="bg-white/60 rounded-2xl p-4 border border-border/40 shadow-sm backdrop-blur-sm lg:col-span-2 flex flex-col justify-center">
            <p class="text-xs font-semibold uppercase tracking-wider text-muted-foreground mb-1">Current Monthly Total vs New</p>
